...
export default function SubmissionsPage() {
    ...
    const filteredSubmissions = useMemo(() => {
        ...
        return submissions.filter(submission => submission.form_id === selectedFormId)
                    ...
                    <Card>
                        ...
                        <CardContent>
                            {isLoading ? (
                                ...
                                <div className="text-center py-8">
                                    <p className="text-gray-600 dark:text-gray-400">No submissions found for the selected form.</p>
                                </div>
                            ) : (
                                <Table>
                                    <TableHeader>
