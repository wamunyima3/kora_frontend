...
class MockDatabase {
    ...
    async initialize() {
        ...
        this.fields = [
            ...
            { id: 2, label: 'Middle Name', data_type_id: 1, group_id: 1, status: false, collection_id: null },
            ...
            { id: 9, label: 'Entity Name', data_type_id: 1, group_id: 3, status: false, collection_id: null },
            { id: 10, label: 'Body Corporate Type', data_type_id: 5, group_id: null, status: false, collection_id: 2 },
            { id: 11, label: 'Registration Number', data_type_id: 2, group_id: 3, status: false, collection_id: null },
            { id: 12, label: 'Country of Incorporation', data_type_id: 5, group_id: null, status: false, collection_id: 4 },
            { id: 13, label: 'Registration Date', data_type_id: 3, group_id: 3, status: false, collection_id: null },
            ...
            { id: 17, label: 'Province', data_type_id: 5, group_id: 2, status: false, collection_id: 5 },
            { id: 18, label: 'Town', data_type_id: 5, group_id: 2, status: false, collection_id: null },
            { id: 19, label: 'Area', data_type_id: 5, group_id: 2, status: false, collection_id: null },
            { id: 20, label: 'Street', data_type_id: 1, group_id: 2, status: false, collection_id: null },
            { id: 21, label: 'Plot House Village', data_type_id: 1, group_id: 2, status: false, collection_id: null },
            { id: 22, label: 'Entity Type', data_type_id: 5, group_id: 3, status: false, collection_id: 2 },
            { id: 23, label: 'Entity Limit', data_type_id: 5, group_id: 3, status: false, collection_id: null },
            { id: 24, label: 'Entity Category', data_type_id: 5, group_id: 3, status: false, collection_id: 2 },
            ...
            { id: 27, label: 'Business Activity', data_type_id: 6, group_id: null, status: false, collection_id: null },
            { id: 28, label: 'Promoter Name', data_type_id: 1, group_id: null, status: false, collection_id: null },
